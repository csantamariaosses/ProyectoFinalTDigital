...
public class ProyectoFinalTDigitalApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProyectoFinalTDigitalApplication.class, args);
	}
...
class AppStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        procedimiento.setDescripcion("Descripcion....");
        procedimiento.setPrecio( 30000);
        procedimiento.setEstado(1);
        
        servicioProcedimiento.registrarProcedimiento( procedimiento );
        
        procedimiento = new Procedimiento();
        procedimiento.setCodProcedimiento("PRO-003");
        procedimiento.setNombre("Nombre Procedimiento 3");
        procedimiento.setDescripcion("Descripcion....");
        procedimiento.setPrecio( 100000);
        procedimiento.setEstado(1);
